...
import static com.example.galrewardsfinal.LatestProductCode.arrayList;
//import static com.example.galrewardsfinal.LatestProductCode.arraylist;

public class ProductAdapterNew extends RecyclerView.Adapter<ProductAdapterNew.ViewHolder> {

    public static ArrayList<ProductModel> NewproductsArray;
    ...
    public ProductAdapterNew(ArrayList<ProductModel> productsArrayNew, Context context, HomeCallBack mCallBackus) {
        this.NewproductsArray = productsArrayNew;
    ...
    @NonNull
    @Override
    public ProductAdapterNew.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.product_adapter_layout, viewGroup, false);
        return new ProductAdapterNew.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final ProductAdapterNew.ViewHolder viewHolder, final int i) {
        //viewHolder.productImage.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.bag));
        viewHolder.productName.setText(NewproductsArray.get(i).productName);
        viewHolder.productImage.setImageDrawable(ContextCompat.getDrawable(context, NewproductsArray.get(i).imagePath));
...
//
                        ...
                        LatestProductCode.cart_count = cartModels.size();
